  ...
  return (
    <Container>
      ...
      <div>
        ...
        <ExternalUnderlineLink href="https://www.cloudera.com/more/services-and-support/fast-forward-labs.html">
          Website
        </ExternalUnderlineLink>
        <LinkSpacer> </LinkSpacer>
        <ExternalUnderlineLink href="http://blog.fastforwardlabs.com/">
          Blog
        </ExternalUnderlineLink>
        <LinkSpacer> </LinkSpacer>
        <ExternalUnderlineLink href="http://twitter.com/fastforwardlabs">
          Twitter
        </ExternalUnderlineLink>
      </div>
    </Container>
